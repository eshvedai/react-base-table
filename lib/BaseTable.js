...
function (_React$PureComponent) {
  ...
  function BaseTable(props) {
    ...
    _this._leftRowHeightMap = {};
    _this._rightRowHeightMap = {};
    _this._getEstimatedTotalRowsHeight = (0, _memoizeOne["default"])(_utils.getEstimatedTotalRowsHeight);
  ...
  (0, _createClass2["default"])(BaseTable, [{
    ...
    value: function renderMainTable() {
      ...
      var Table = this._getComponent('Table');

      return _react["default"].createElement(Table, (0, _extends2["default"])({}, rest, this.state, {
    ...
    value: function _getRowHeight(rowIndex) {
      ...
      return this._rowHeightMap[this._data[rowIndex][rowKey]] || (0, _utils.callOrReturn)(estimatedRowHeight, {
...
BaseTable.propTypes = {
   ...
   */
  estimatedRowHeight: _propTypes["default"].oneOfType([_propTypes["default"].number, _propTypes["default"].func]),
